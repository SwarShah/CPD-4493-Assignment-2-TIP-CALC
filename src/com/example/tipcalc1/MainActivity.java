...
public class MainActivity extends Activity {
	...
	private RadioGroup randioGroup;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		randioGroup = (RadioGroup) findViewById(R.id.radioGroup1);
		...
		randioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	...
	private void updateStandard() {
		...
		// taxValue.getText().toString(), Toast.LENGTH_LONG).show();
		...
		pp15TextView.setText(currencyFormat
				.format(fifteenPercentTotal / person));
	}
